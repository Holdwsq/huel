 ...
 *
 */
public class GaviActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void initView() {
        mMenuLayout1 = findViewById(R.id.home);
        mMenuLayout2 = findViewById(R.id.jjj);

        mMenuLayout3 = findViewById(R.id.cart);
        mMenuLayout4 = findViewById(R.id.set);
